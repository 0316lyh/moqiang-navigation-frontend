...
export default {
  ...
  methods: {
    // 获取数据
    getAll() {
      axios.get('/website/getbytoptype/' + 'nav/' + this.pageSize + '/' + this.currentPage).then((res) => {
    ...
    // 获取分页总条数
    getTotal() {
      axios.get('/website/getTotal/' + 'nav').then((res) => {
    ...
    handleCurrentChange(currentPage) {
      ...
      axios.get('/website/getbytoptype/' + 'nav/' + this.pageSize + '/' + currentPage).then((res) => {
